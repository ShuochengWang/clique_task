...
use sgx_types::{
    sgx_attributes_t, sgx_key_128bit_t, sgx_key_id_t, sgx_key_request_t, sgx_report_data_t,
    sgx_report_t, sgx_target_info_t, SGX_KEYID_SIZE, SGX_KEYPOLICY_MRENCLAVE, SGX_KEYSELECT_SEAL,
